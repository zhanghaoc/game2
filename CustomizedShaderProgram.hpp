...
struct CustomizedShaderProgram {
...
extern Load< CustomizedShaderProgram > customized_shader_program;
...
extern Scene::Drawable::Pipeline customized_shader_program_pipeline;
